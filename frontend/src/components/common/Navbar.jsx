        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <a href="login.html" class="text-slate-600 hover:text-slate-900 transition-colors font-medium">Login</a>
                    <a href="signup.html" class="px-6 py-2.5 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all font-medium">Get Started</a>
                </div>
            </div>
        </div>
    </nav>
